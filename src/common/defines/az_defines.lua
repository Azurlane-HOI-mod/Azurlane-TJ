...
NDefines.NAI.PLAN_ACTIVATION_SUPERIORITY_AGGRO = 1.5						--这个数值越大AI执行计划越谨慎
NDefines.NAI.MIN_PLAN_VALUE_TO_MICRO_INACTIVE = 0.4						--AI将不考虑计划未被激活并且评估低于此数值的计划
NDefines.NAI.ATTACK_HEAVILY_DEFENDED_LIMIT = 2.0							--AI不会对防御严密的战线发动攻击，除非他们认为自己拥有这种优势（1.0=100%）
NDefines.NAI.RESEARCH_BONUS_FACTOR = 50.0									-- AI会优先研发有科技加成的科技
...
NDefines.NAI.CANCEL_COMBAT_MIN_DURATION_HOURS = 12						--仅当战斗持续至少<数值>小时后，方可取消（常规）战斗
--NDefines.NAI.MIN_FIELD_STRENGTH_TO_BUILD_UNITS = 0.6						--若当前兵力强度低于此阈值，则取消单位生产以将资源调配至前线部队    原版0.7
--NDefines.NAI.MIN_MANPOWER_TO_BUILD_UNITS = 0.5						--若当前人力水平低于此阈值，则取消单位生产以将资源调配至现役部队    原版0.7
...
--NDefines.NNavy.SHORE_BOMBARDMENT_CAP = 1.0          --对岸炮击数值上限（原0.33，应狗崽子要求改为1.0）1.0太高，屏蔽了
